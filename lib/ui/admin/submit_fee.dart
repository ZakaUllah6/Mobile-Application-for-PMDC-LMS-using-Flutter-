...
class SubmitFee extends StatefulWidget {
  SubmitFee({Key? key}) : super(key: key);

  @override
  State<SubmitFee> createState() => _SubmitFeeState();
}

class _SubmitFeeState extends State<SubmitFee> {
                      ...
                      child: signIn_login_Btn_widget(
                          onTap: () async {
                            if (model.formKey.currentState!.validate()) {
                              model.getStudent(studentId.text, context);
                            }
